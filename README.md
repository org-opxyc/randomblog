...
# Tweaks
- Added two pages /en and /jp denoting English and Japanese.
- In Contentful, edited a blog to include Japanese. 
- Added a small filter in graphql to select language specific blogs from contentful

```js
export const pageQuery = graphql`
  query JPIndexQuery {
    allContentfulBlogPost(filter: {language: {eq: "jp"}}
    ...
  `
```

- Added a worker file which can be used in Cloudflare for redirecting to /en or /jp according to the users' location. Read more about worker [here](./worker/).
